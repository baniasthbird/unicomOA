...
-(void)buildView {
    UILabel *lbl_label1=[[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width*0.08, self.view.frame.size.height*0.31, self.view.frame.size.width*0.2, self.view.frame.size.height*0.05)];
    ...
    UILabel *lbl_label2=[[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width*0.3, self.view.frame.size.height*0.31, self.view.frame.size.width*0.2, self.view.frame.size.height*0.05)];
    ...
    UILabel *lbl_label3=[[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width*0.45, self.view.frame.size.height*0.31, self.view.frame.size.width*0.05, self.view.frame.size.height*0.05)];
    lbl_label3.text=@"30";
    ...
    UILabel *lbl_label4=[[UILabel alloc]initWithFrame:CGRectMake(self.view.frame.size.width*0.5, self.view.frame.size.height*0.31, self.view.frame.size.width*0.35, self.view.frame.size.height*0.05)];
...
-(void)buildButton {
    UIButton *btn_result=[[UIButton alloc]initWithFrame:CGRectMake(0, self.view.frame.size.height*0.85, self.view.frame.size.width*0.495, self.view.frame.size.height*0.08)];
    ...
    UIButton *btn_vote=[[UIButton alloc]initWithFrame:CGRectMake(self.view.frame.size.width*0.5, self.view.frame.size.height*0.85, self.view.frame.size.width*0.495, self.view.frame.size.height*0.08)];
