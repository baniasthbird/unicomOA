...
-(UIColor *)bgColor {
    if (_bgColor== nil) {
        _bgColor= [UIColor colorWithRed:73/255.0f green:118/255.0f blue:231/255.0f alpha:1];
    }
    return _bgColor;
}
...
- (void)viewDidLayoutSubviews
{
   ...
   // CGFloat titleY = _isfullScreen ? contentY : 0;
    ...
    self.contentScrollView.frame = _isfullScreen ? CGRectMake(0, titleH, contentW, LXScreenH) : CGRectMake(0, contentScrollY, contentW, self.contentView.height - contentScrollY);
}
