...
-(void)initWave {
    ...
    [[UIImage imageNamed:@"filefolderbg"] drawInRect:self.bounds];
    ...
    self.firstWaveColor = RGBA(244, 205, 21, 0.5);
    self.secondWaveColor = RGBA(244, 205, 21, 1);
    
    self.firstShapeLayer.fillColor=[self.firstWaveColor CGColor];
    self.secondShapeLayer.fillColor=[self.secondWaveColor CGColor];
    self.isShowWave = YES;
...
-(void)clearWave {
    ...
    self.secondShapeLayer.fillColor=[[UIColor clearColor] CGColor];
