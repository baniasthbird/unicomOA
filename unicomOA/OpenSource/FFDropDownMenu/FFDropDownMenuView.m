...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.menuWidth = 0.38*Width;
        self.menuCornerRadius = 0;
        self.eachMenuItemHeight = 0.069*Height;
...
- (void)setup {
  ...
  //  self.menuViewFrame = CGRectMake(horizonWidth - self.menuWidth - self.menuRightMargin, CGRectGetMaxY(self.triangleView.frame), self.menuWidth, self.eachMenuItemHeight * self.menuModelsArray.count);
     self.menuViewFrame = CGRectMake(CGRectGetMinX(self.triangleView.frame)-10, CGRectGetMaxY(self.triangleView.frame), self.menuWidth, self.eachMenuItemHeight * self.menuModelsArray.count);
...
- (UITableView *)tableView {
    if (_tableView == nil) {
        ...
        tableView.backgroundColor = [UIColor colorWithWhite:215 / 255.0 alpha:1];;
