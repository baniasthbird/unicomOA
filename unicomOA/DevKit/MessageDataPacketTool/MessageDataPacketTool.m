...
+ (NSData *)handshakeMessagePacketData {
  ...
  //  [writerPacket writeString:identifierForVendor];
    //设备deviceToken
    NSString *deviceToken=[MPUserDefaults objectForKey:MPDeviceToken];
    [writerPacket writeString:deviceToken];
...
+ (NSData *)fastConnect{
    ...
    NSString *deviceId = [MPUserDefaults objectForKey:MPDeviceToken];
